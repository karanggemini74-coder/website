...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; desc: string }> = ({ icon, title, desc }) => (
  <div className="group bg-white p-8 rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-brand-100 transition-all duration-300">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <div className="relative overflow-hidden bg-slate-900 text-white min-h-[90vh] flex items-center">
        ...
        {/* Decorative blobs */}
        <div className="absolute top-20 right-0 w-96 h-96 bg-brand-500/20 rounded-full blur-3xl z-10"></div>
        <div className="absolute bottom-0 left-0 w-72 h-72 bg-accent-500/10 rounded-full blur-3xl z-10"></div>

        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-brand-100 text-sm font-medium mb-8">
               <span className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></span>
               SEBI Registered Research Analyst (Reg. No. INH00000XXXX)
            </div>
            ...
            <p className="text-lg text-brand-200 mb-8 font-medium italic opacity-90">
      ...
      <div className="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 mb-20">
        <div className="bg-white rounded-2xl shadow-xl border border-slate-100 p-8 md:p-12 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-100">
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto text-center px-4">
          <span className="text-brand-600 font-bold uppercase tracking-widest text-sm mb-4 block">Our Mission</span>
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-8">On a Mission</h2>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div className="group relative overflow-hidden bg-slate-900 text-white rounded-3xl p-10 shadow-2xl transition-transform hover:-translate-y-1">
            ...
            <div className="group relative overflow-hidden bg-brand-700 text-white rounded-3xl p-10 shadow-2xl transition-transform hover:-translate-y-1">
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Core Pillars</h2>
            <p className="text-xl text-slate-500 max-w-2xl mx-auto">The foundation of our research excellence and commitment to your financial growth.</p>
          </div>
