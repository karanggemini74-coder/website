  ...
  return (
    <ComplianceLayout title="Disclosure of Status of Compliance Audit Report">
      ...
      <div className="space-y-6">
        <p>Since <strong>Karan Vijayvargiya</strong> received its SEBI Research Analyst Registration (<strong>Reg. No. INH00000XXXXX</strong>) on <strong>August 22, 2025</strong>, one full financial year has <strong className="text-red-600">not yet been completed</strong>.</p>
